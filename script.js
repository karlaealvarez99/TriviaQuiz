...
const Questions = [{
    ...
    a: [{ text: "Kidney", isCorrect: false },
        { text: "Intestines", isCorrect: false },
...
{
    id: 1,
    q: "How many dead skin sells do we shed in a minute?",
...
{
    id: 2,
    q: "When Cardi B raps about that dangly thang that swings in the back of her throat, what was she referring to?",
    a: [{ text: "Posterior", isCorrect: false },
        { text: "Larynx", isCorrect: false },
        { text: "Uvula", isCorrect: true },
